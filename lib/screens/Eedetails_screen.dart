...
class Eedetails_screen extends StatelessWidget {
  @override
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Basic Concepts",
                        chapterNumber: 1,
                        tag: "Source transformation technique,Mesh..",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Network Theorems",
                        chapterNumber: 2,
                        tag: "Superposition theorems,thevenin's theo",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Resonance in EC",
                        chapterNumber: 3,
                        tag: "Variation in impedance with freq",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Initial concepts",
                        chapterNumber: 4,
                        tag: "Initial Concepts in R,L,C & RLC net",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Transient  DC circuits",
                        chapterNumber: 5,
                        tag: "Growth & decay of current in RL circ",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Fourier Series",
                        chapterNumber: 6,
                        tag: "Determination of fourier coefficient..",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Laplace Transforms",
                        chapterNumber: 7,
                        tag: "Laplace Transforms of various signals..",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Coupled Circuits",
                        chapterNumber: 8,
                        tag: "Magnetic & coefficient of Coupling",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
