...
class Ecdetails_screen extends StatelessWidget {
  @override
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Diode Circuits",
                        chapterNumber: 1,
                        tag: "Clippers,Clampers",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Small Signal analysis",
                        chapterNumber: 2,
                        tag: "BJT transistor small signal AC,analysis",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "field effect transistors",
                        chapterNumber: 3,
                        tag: "construction and characters of JFET",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Small SA of FET",
                        chapterNumber: 4,
                        tag: "FET small signal model,JFET fixed bias",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Feedback amplifiers",
                        chapterNumber: 5,
                        tag: "feedback concept,feedback conn types",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Power amplifiers",
                        chapterNumber: 5,
                        tag: "Defn,classification,series fed",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
