...
import 'package:book_app/youtubelinks/iselinks.dart';
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Introduction",
                        chapterNumber: 1,
                        tag: "Arrays,function,pointers,Structures",
                        press: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      ChapterCard(
                        name: "Searching",
                        chapterNumber: 2,
                        tag: "Linear,Binary Search technique",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Linked Lists",
                        chapterNumber: 3,
                        tag: "Single & doubly Linked Lists",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Stacks & Queues",
                        chapterNumber: 4,
                        tag: "ADT Stacks and ADT Queues",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Trees",
                        chapterNumber: 4,
                        tag: "Binary Trees and Basics",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
